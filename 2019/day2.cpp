...
void solve(const std::string &input, const std::string &expectedOutput)
{
    Machine machine = buildMachine(input);
    run(machine);

    for (const int &cell : machine)
    {
        std::cout << cell << ",";
    }
    std::cout << "=";
...
int main()
{
    solve("1,0,0,0,99", "2,0,0,0,99");
    solve("2,3,0,3,99", "2,3,0,6,99");
    solve("2,4,4,5,99,0", "2,4,4,5,99,9801");
    solve("1,1,1,4,99,5,6,0,99", "30,1,1,4,2,5,6,0,99");
